...
const topic = "sports";
const apiUrl2 = `https://newsapi.org/v2/top-headlines?q=${topic}&country=us&apiKey=${apiKey}`;
...
const topic2 = "tech";
const apiUrl3 = `https://newsapi.org/v2/top-headlines?q=${topic2}&country=us&apiKey=${apiKey}`;
...
const topic3 = "life";
const apiUrl4 = `https://newsapi.org/v2/top-headlines?q=${topic3}&country=us&apiKey=${apiKey}`;
...
// const apiKey5 = "78e82696e81b45aca23fa75797f7f379";
// const topic5 = "sport";
// const apiUrl5 = `https://newsapi.org/v2/top-headlines?q=${encodeURIComponent(
//   topic5
// )}&country=eg&apiKey=${apiKey5}`;
